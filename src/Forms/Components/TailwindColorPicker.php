...
class TailwindColorPicker extends Field
{
    ...
    public $colors = [
        ...
        ['hex' => '#f1f5f9', 'twLabel' => 'slate-100', 'twBgLabel' => 'bg-slate-100', 'twTextLabel' => 'text-slate-100'],
        ...
        ['hex' => '#dbeafe', 'twLabel' => 'blue-100', 'twBgLabel' => 'bg-blue-100', 'twTextLabel' => 'text-blue-100'],
        ['hex' => '#bfdbfe', 'twLabel' => 'blue-200', 'twBgLabel' => 'bg-blue-200', 'twTextLabel' => 'text-blue-200'],
        ['hex' => '#93c5fd', 'twLabel' => 'blue-300', 'twBgLabel' => 'bg-blue-300', 'twTextLabel' => 'text-blue-300'],
        ['hex' => '#60a5fa', 'twLabel' => 'blue-400', 'twBgLabel' => 'bg-blue-400', 'twTextLabel' => 'text-blue-400'],
        ['hex' => '#3b82f6', 'twLabel' => 'blue-500', 'twBgLabel' => 'bg-blue-500', 'twTextLabel' => 'text-blue-500'],
        ['hex' => '#2563eb', 'twLabel' => 'blue-600', 'twBgLabel' => 'bg-blue-600', 'twTextLabel' => 'text-blue-600'],
        ['hex' => '#1d4ed8', 'twLabel' => 'blue-700', 'twBgLabel' => 'bg-blue-700', 'twTextLabel' => 'text-blue-700'],
        ['hex' => '#1e40af', 'twLabel' => 'blue-800', 'twBgLabel' => 'bg-blue-800', 'twTextLabel' => 'text-blue-800'],
        ['hex' => '#1e3a8a', 'twLabel' => 'blue-900', 'twBgLabel' => 'bg-blue-900', 'twTextLabel' => 'text-blue-900'],

        // Indigo
        ['hex' => '#eef2ff', 'twLabel' => 'indigo-50',  'twBgLabel' => 'bg-indigo-50',  'twTextLabel' => 'text-indigo-50'],
        ['hex' => '#e0e7ff', 'twLabel' => 'indigo-100', 'twBgLabel' => 'bg-indigo-100', 'twTextLabel' => 'text-indigo-100'],
        ['hex' => '#c7d2fe', 'twLabel' => 'indigo-200', 'twBgLabel' => 'bg-indigo-200', 'twTextLabel' => 'text-indigo-200'],
        ['hex' => '#a5b4fc', 'twLabel' => 'indigo-300', 'twBgLabel' => 'bg-indigo-300', 'twTextLabel' => 'text-indigo-300'],
        ['hex' => '#818cf8', 'twLabel' => 'indigo-400', 'twBgLabel' => 'bg-indigo-400', 'twTextLabel' => 'text-indigo-400'],
        ['hex' => '#6366f1', 'twLabel' => 'indigo-500', 'twBgLabel' => 'bg-indigo-500', 'twTextLabel' => 'text-indigo-500'],
        ['hex' => '#4f46e5', 'twLabel' => 'indigo-600', 'twBgLabel' => 'bg-indigo-600', 'twTextLabel' => 'text-indigo-600'],
        ['hex' => '#4338ca', 'twLabel' => 'indigo-700', 'twBgLabel' => 'bg-indigo-700', 'twTextLabel' => 'text-indigo-700'],
        ['hex' => '#3730a3', 'twLabel' => 'indigo-800', 'twBgLabel' => 'bg-indigo-800', 'twTextLabel' => 'text-indigo-800'],
        ['hex' => '#312e81', 'twLabel' => 'indigo-900', 'twBgLabel' => 'bg-indigo-900', 'twTextLabel' => 'text-indigo-900'],

        // Violet
        ['hex' => '#f5f3ff', 'twLabel' => 'violet-50',  'twBgLabel' => 'bg-violet-50',  'twTextLabel' => 'text-violet-50'],
        ['hex' => '#ede9fe', 'twLabel' => 'violet-100', 'twBgLabel' => 'bg-violet-100', 'twTextLabel' => 'text-violet-100'],
        ['hex' => '#ddd6fe', 'twLabel' => 'violet-200', 'twBgLabel' => 'bg-violet-200', 'twTextLabel' => 'text-violet-200'],
        ['hex' => '#c4b5fd', 'twLabel' => 'violet-300', 'twBgLabel' => 'bg-violet-300', 'twTextLabel' => 'text-violet-300'],
        ['hex' => '#a78bfa', 'twLabel' => 'violet-400', 'twBgLabel' => 'bg-violet-400', 'twTextLabel' => 'text-violet-400'],
        ['hex' => '#8b5cf6', 'twLabel' => 'violet-500', 'twBgLabel' => 'bg-violet-500', 'twTextLabel' => 'text-violet-500'],
        ['hex' => '#7c3aed', 'twLabel' => 'violet-600', 'twBgLabel' => 'bg-violet-600', 'twTextLabel' => 'text-violet-600'],
        ['hex' => '#6d28d9', 'twLabel' => 'violet-700', 'twBgLabel' => 'bg-violet-700', 'twTextLabel' => 'text-violet-700'],
        ['hex' => '#5b21b6', 'twLabel' => 'violet-800', 'twBgLabel' => 'bg-violet-800', 'twTextLabel' => 'text-violet-800'],
        ['hex' => '#4c1d95', 'twLabel' => 'violet-900', 'twBgLabel' => 'bg-violet-900', 'twTextLabel' => 'text-violet-900'],

        // Purple
        ['hex' => '#faf5ff', 'twLabel' => 'purple-50',  'twBgLabel' => 'bg-purple-50',  'twTextLabel' => 'text-purple-50'],
        ['hex' => '#f3e8ff', 'twLabel' => 'purple-100', 'twBgLabel' => 'bg-purple-100', 'twTextLabel' => 'text-purple-100'],
        ['hex' => '#e9d5ff', 'twLabel' => 'purple-200', 'twBgLabel' => 'bg-purple-200', 'twTextLabel' => 'text-purple-200'],
        ['hex' => '#d8b4fe', 'twLabel' => 'purple-300', 'twBgLabel' => 'bg-purple-300', 'twTextLabel' => 'text-purple-300'],
        ['hex' => '#c084fc', 'twLabel' => 'purple-400', 'twBgLabel' => 'bg-purple-400', 'twTextLabel' => 'text-purple-400'],
        ['hex' => '#a855f7', 'twLabel' => 'purple-500', 'twBgLabel' => 'bg-purple-500', 'twTextLabel' => 'text-purple-500'],
        ['hex' => '#9333ea', 'twLabel' => 'purple-600', 'twBgLabel' => 'bg-purple-600', 'twTextLabel' => 'text-purple-600'],
        ['hex' => '#7e22ce', 'twLabel' => 'purple-700', 'twBgLabel' => 'bg-purple-700', 'twTextLabel' => 'text-purple-700'],
        ['hex' => '#6b21a8', 'twLabel' => 'purple-800', 'twBgLabel' => 'bg-purple-800', 'twTextLabel' => 'text-purple-800'],
        ['hex' => '#581c87', 'twLabel' => 'purple-900', 'twBgLabel' => 'bg-purple-900', 'twTextLabel' => 'text-purple-900'],

        // Fuschia
        ['hex' => '#fdf4ff', 'twLabel' => 'fuchsia-50',  'twBgLabel' => 'bg-fuchsia-50',  'twTextLabel' => 'text-fuchsia-50'],
        ['hex' => '#fae8ff', 'twLabel' => 'fuchsia-100', 'twBgLabel' => 'bg-fuchsia-100', 'twTextLabel' => 'text-fuchsia-100'],
        ['hex' => '#f5d0fe', 'twLabel' => 'fuchsia-200', 'twBgLabel' => 'bg-fuchsia-200', 'twTextLabel' => 'text-fuchsia-200'],
        ['hex' => '#f0abfc', 'twLabel' => 'fuchsia-300', 'twBgLabel' => 'bg-fuchsia-300', 'twTextLabel' => 'text-fuchsia-300'],
        ['hex' => '#e879f9', 'twLabel' => 'fuchsia-400', 'twBgLabel' => 'bg-fuchsia-400', 'twTextLabel' => 'text-fuchsia-400'],
        ['hex' => '#d946ef', 'twLabel' => 'fuchsia-500', 'twBgLabel' => 'bg-fuchsia-500', 'twTextLabel' => 'text-fuchsia-500'],
        ['hex' => '#c026d3', 'twLabel' => 'fuchsia-600', 'twBgLabel' => 'bg-fuchsia-600', 'twTextLabel' => 'text-fuchsia-600'],
        ['hex' => '#a21caf', 'twLabel' => 'fuchsia-700', 'twBgLabel' => 'bg-fuchsia-700', 'twTextLabel' => 'text-fuchsia-700'],
        ['hex' => '#86198f', 'twLabel' => 'fuchsia-800', 'twBgLabel' => 'bg-fuchsia-800', 'twTextLabel' => 'text-fuchsia-800'],
        ['hex' => '#701a75', 'twLabel' => 'fuchsia-900', 'twBgLabel' => 'bg-fuchsia-900', 'twTextLabel' => 'text-fuchsia-900'],

        // Pink
        ['hex' => '#fdf2f8', 'twLabel' => 'pink-50',  'twBgLabel' => 'bg-pink-50',  'twTextLabel' => 'text-pink-50'],
        ['hex' => '#fce7f3', 'twLabel' => 'pink-100', 'twBgLabel' => 'bg-pink-100', 'twTextLabel' => 'text-pink-100'],
        ['hex' => '#fbcfe8', 'twLabel' => 'pink-200', 'twBgLabel' => 'bg-pink-200', 'twTextLabel' => 'text-pink-200'],
        ['hex' => '#f9a8d4', 'twLabel' => 'pink-300', 'twBgLabel' => 'bg-pink-300', 'twTextLabel' => 'text-pink-300'],
        ['hex' => '#f472b6', 'twLabel' => 'pink-400', 'twBgLabel' => 'bg-pink-400', 'twTextLabel' => 'text-pink-400'],
        ['hex' => '#ec4899', 'twLabel' => 'pink-500', 'twBgLabel' => 'bg-pink-500', 'twTextLabel' => 'text-pink-500'],
        ['hex' => '#db2777', 'twLabel' => 'pink-600', 'twBgLabel' => 'bg-pink-600', 'twTextLabel' => 'text-pink-600'],
        ['hex' => '#be185d', 'twLabel' => 'pink-700', 'twBgLabel' => 'bg-pink-700', 'twTextLabel' => 'text-pink-700'],
        ['hex' => '#9d174d', 'twLabel' => 'pink-800', 'twBgLabel' => 'bg-pink-800', 'twTextLabel' => 'text-pink-800'],
        ['hex' => '#831843', 'twLabel' => 'pink-900', 'twBgLabel' => 'bg-pink-900', 'twTextLabel' => 'text-pink-900'],

        // Pink
        ['hex' => '#fff1f2', 'twLabel' => 'rose-50',  'twBgLabel' => 'bg-rose-50',  'twTextLabel' => 'text-rose-50'],
        ['hex' => '#ffe4e6', 'twLabel' => 'rose-100', 'twBgLabel' => 'bg-rose-100', 'twTextLabel' => 'text-rose-100'],
        ['hex' => '#fecdd3', 'twLabel' => 'rose-200', 'twBgLabel' => 'bg-rose-200', 'twTextLabel' => 'text-rose-200'],
        ['hex' => '#fda4af', 'twLabel' => 'rose-300', 'twBgLabel' => 'bg-rose-300', 'twTextLabel' => 'text-rose-300'],
        ['hex' => '#fb7185', 'twLabel' => 'rose-400', 'twBgLabel' => 'bg-rose-400', 'twTextLabel' => 'text-rose-400'],
        ['hex' => '#f43f5e', 'twLabel' => 'rose-500', 'twBgLabel' => 'bg-rose-500', 'twTextLabel' => 'text-rose-500'],
        ['hex' => '#e11d48', 'twLabel' => 'rose-600', 'twBgLabel' => 'bg-rose-600', 'twTextLabel' => 'text-rose-600'],
        ['hex' => '#be123c', 'twLabel' => 'rose-700', 'twBgLabel' => 'bg-rose-700', 'twTextLabel' => 'text-rose-700'],
        ['hex' => '#9f1239', 'twLabel' => 'rose-800', 'twBgLabel' => 'bg-rose-800', 'twTextLabel' => 'text-rose-800'],
        ['hex' => '#881337', 'twLabel' => 'rose-900', 'twBgLabel' => 'bg-rose-900', 'twTextLabel' => 'text-rose-900'],

        // black, white
        ['hex' => '#ffffff', 'twLabel' => 'white', 'twBgLabel' => 'bg-white', 'twTextLabel' => 'text-white'],
        ['hex' => '#000000', 'twLabel' => 'black',  'twBgLabel' => 'bg-black',  'twTextLabel' => 'text-black'],
